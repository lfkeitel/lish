...
// https://github.com/contain-rs/cons-list

// Modifications from the original work made by Lee Keitel.
...
mod tests {
    ...
    fn test_hash() {
        ...
        let mut h1 = hash_map::DefaultHasher::new();
        hash::Hash::hash(&x, &mut h1);
        let mut h2 = hash_map::DefaultHasher::new();
        hash::Hash::hash(&y, &mut h2);
        ...
        h1 = hash_map::DefaultHasher::new();
        hash::Hash::hash(&x, &mut h1);
        h2 = hash_map::DefaultHasher::new();
        hash::Hash::hash(&y, &mut h2);
